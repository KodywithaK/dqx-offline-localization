...
|          |                   The Endgame of Eternity                   | `de` 🔴 <br> `en` 🔴 <br> `es` 🔴 <br> `fr` 🔴 <br> `it` 🔴 <br> `pt-BR` 🔴 |            |
...
|              |  006  | `de` 🔴 <br> `en` 🔴 <br> `es` 🔴 <br> `fr` 🔴 <br> `it` 🔴 <br> `pt-BR` 🔴 |            |
...
|              |  014  | `de` 🔴 <br> `en` 🔴 <br> `es` 🔴 <br> `fr` 🔴 <br> `it` 🔴 <br> `pt-BR` 🔴 |            |
...
|              |  283  | `de` 🔴 <br> `en` 🔴 <br> `es` 🔴 <br> `fr` 🔴 <br> `it` 🔴 <br> `pt-BR` 🔴 |            |
|              |  284  | `de` 🔴 <br> `en` 🔴 <br> `es` 🔴 <br> `fr` 🔴 <br> `it` 🔴 <br> `pt-BR` 🔴 |            |
|              |  285  | `de` 🔴 <br> `en` 🔴 <br> `es` 🔴 <br> `fr` 🔴 <br> `it` 🔴 <br> `pt-BR` 🔴 |            |
