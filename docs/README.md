...
> | pakchunk17-WindowsNoEditor | [ガンガン冒険セット①](https://steamdb.info/depot/1838368/)                                   | Square-Enix - Official Guidebook, Ver. 2<br>Download Code (1/2) |
...
> | pakchunk21-WindowsNoEditor | [ガンガン冒険セット②](https://steamdb.info/depot/1900220/)                                   | Square-Enix - Official Guidebook, Ver. 2<br>Download Code (2/2) |
...
>   - WindowsNoEditor*<YOUR_MOD_NAME>*<YOUR_MOD_VERSION>\_P.(pak/ucas/utoc)"`
>
> ## 2.Start up the game
>
...
>     6. `make UnrealPak` - makes `Unrealpak` and its dependencies in ~80-210s
>     <!--
>     7. `make UE4Editor`
