...
> # Game.locres.yaml
>
> - Check `$comments` sections in the file for more details.
>
> ## Index
>
> <details>
...
> | STT_ActionMsg_Log1                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple1`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log2                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple2`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log3                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple3`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log4                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple4`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log5                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple5`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log6                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple6`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log7                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple7`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log8                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple8`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log9                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple9`                                                                                                                                                                                                                                   |
> | STT_ActionMsg_Log10                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple10`                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Log11                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple11`                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Log12                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple12`                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Log13                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple13`                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Log14                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple14`                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Log15                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages (Log - `Battle` Tab), see `STT_ActionMsg_Simple15`                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple1               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log1`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple2               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log2`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple3               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log3`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple4               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log4`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple5               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log5`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple6               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log6`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple7               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log7`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple8               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log8`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple9               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log9`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple10              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log0`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple11              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log1`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple12              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log2`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple13              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log3`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple14              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log4`                                                                                                                                                                                                                                                  |
> | STT_ActionMsg_Simple15              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Battle messages - popups, see `STT_ActionMsg_Log5`                                                                                                                                                                                                                                                  |
...
> | STT_Battle_UI                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_BattleroadSys                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_Boukennosho_DLC_Text            | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Japanese version's DLC names and descriptions, see `ASIA_DLC`                                                                                                                                                                                                                                       |
...
> | STT_DaijinamonoItem                 | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | names + descriptions of key items, ~30 characters long                                                                                                                                                                                                                                              |
> | STT_Dorubaord                       | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    | No Dolboard                                                                                                                                                                                                                                                                                         |
> | STT_DungeonKingdomSys               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_DungeonMagicNPC                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_Emote                           | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | Performable emotes, see `STT_Gesture`                                                                                                                                                                                                                                                               |
> | STT_Equip_Coordinate                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Glamour / My coordinated outfits                                                                                                                                                                                                                                                                    |
> | STT_Equip_OddStatus_Name            | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_EventMonsterName                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_EventPalceName                  | 🟡  | 🟢  | 🟡  | 🟡  | 🟡  | 🟡    | The Story So Far place names                                                                                                                                                                                                                                                                        |
...
> | STT_IraisyoArasuji                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Strike Request Forms' details<br>~100ch¹ long, 8 lines high<br>[1] accounting for `{MonsterName} / STT_IraisyoMonsterType` length                                                                                                                                                                   |
...
> | STT_IraisyoNPCNameRuby              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Strike Request Forms' Client Name ( Ruby )                                                                                                                                                                                                                                                          |
> | STT_ItemExplanation                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_ItemList                        | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_ItemName                        | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_JobChangeNpc                    | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
...
> | STT_LoadingArasujiVer1              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Same as `STT_CareerStoryVer1`, used for initial The Story So Far loading screen                                                                                                                                                                                                                     |
> | STT_LoadingArasujiVer2              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Same as `STT_CareerStoryVer2`, used for initial The Story So Far loading screen                                                                                                                                                                                                                     |
> | STT_LoadingTips                     | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
...
> | STT_Monster_Tips1_ver1              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Monster trivia, see `STT_System_Book_Monster`<br>~35ch long, 4 lines high¹<br>[1] Any texts longer than 4 lines are invisible to players                                                                                                                                                            |
> | STT_Monster_Tips1_ver2              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Monster trivia, see `STT_System_Book_Monster`<br>~35ch long, 4 lines high¹<br>[1] Any texts longer than 4 lines are invisible to players                                                                                                                                                            |
> | STT_Monster_Tips2_Ver2              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Monster trivia, see `STT_System_Book_Monster`<br>~35ch long, 4 lines high¹<br>[1] Any texts longer than 4 lines are invisible to players                                                                                                                                                            |
> | STT_Monster_Tips2_ver1              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Monster trivia, see `STT_System_Book_Monster`<br>~35ch long, 4 lines high¹<br>[1] Any texts longer than 4 lines are invisible to players                                                                                                                                                            |
> | STT_Monster_Type                    | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_NpcInfo                         | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | NPC names                                                                                                                                                                                                                                                                                           |
> | STT_OddStatusExplanation            | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_OddStatusName                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Skill Panel explanations<br>~15ch long, 3 lines high                                                                                                                                                                                                                                                |
> | STT_PT_InOut                        | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Party Chat - Leaving guest's mission area                                                                                                                                                                                                                                                           |
> | STT_PT_Talk                         | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Party Chat<br>see `pakchunk0-{PLATFORM}.utoc\{Game/Holiday}\Content/Datatables\System\System_Party\DT_PT_Talk`<br>Order goes: (`PT_TALK_TXT`\_`ScenarioNo_Start`\_`ScenarioCounter_Start`\_[(`ClearAttend`/`Condition`)\_]`TalkNum`_`SortNum`),<br>E.g., `PT_TALK_TXT`\_`3`\_`100`\_[`2_`]`2`\_`1`) |
...
> | STT_QuestListName                   | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | Quest names<br>~35ch long                                                                                                                                                                                                                                                                           |
> | STT_QuestListSeries                 | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | Quest series names                                                                                                                                                                                                                                                                                  |
> | STT_Quest_AfterBattle               | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    |                                                                                                                                                                                                                                                                                                     |
> | STT_Quest_ItemGet                   | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | Quest required items dialog                                                                                                                                                                                                                                                                         |
> | STT_Quest_PerticularReward          | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | Quest completion rewards<br>~50ch long                                                                                                                                                                                                                                                              |
...
> | STT_SpecialName                     | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_Support_BrowseSys               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | See `STT_Main_UI.SYSTXT_Main_UI_60080`<br>~50 characters                                                                                                                                                                                                                                            |
...
> | STT_SystemTrainNpc                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_SystemTrainSys                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_System_Book_Monster             | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Monster trivia, see `STT_Monster_Tips*_ver*`<br>~35ch long, 4 lines high¹<br>[1] Any texts longer than 4 lines are invisible to players                                                                                                                                                             |
> | STT_System_Casino                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
...
> | STT_System_Location                 | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    | Location names<br>~35ch                                                                                                                                                                                                                                                                             |
> | STT_System_ProfileWord              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_System_Shop_Dougu               | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    | Shop - job title abbreviations next to icon                                                                                                                                                                                                                                                         |
...
> | STT_Sytem_UI_Status                 | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    | Names of attributes                                                                                                                                                                                                                                                                                 |
> | STT_TestText                        | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_TinyMedals                      | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_TinyMedalsWindow                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_Tips_Category                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Tips titles                                                                                                                                                                                                                                                                                         |
> | STT_Tips_Content                    | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Tips content<br>~60ch                                                                                                                                                                                                                                                                               |
> | STT_ToolActionItem                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_UIDouguSys                      | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
> | STT_UIJumonSys                      | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                                                                                                                                                                                     |
...
> | Namespace                                             | de  | en   | es  | fr   | it  | pt-BR  | Comment(s) & Context                                                                                                                 |
> | :---------------------------------------------------- | :-- | :--- | :-- | :--- | :-- | :----- | :----------------------------------------------------------------------------------------------------------------------------------- |
> | eventTextCsA11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.json:STT_EventPalceName.SYSTXT_PLACENAME_00001`<br>Prologue { Human }                                          |
> | eventTextCsA21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10011Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10012Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10013Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10014Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10015Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10021Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10022Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10023Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10024Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10025Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10031Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10032Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10033Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10034Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10035Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10041Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10042Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10043Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10044Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10045Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10051Client.win32.json                   | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (060) SYSTEXT_QUESTLIST_NAME_AQ_005_1 [ SYSTEXT_QUESTLIST_SERIES_AQ_005 ] { Sub Story }                                              |
> | eventTextCsAq10052Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (061) SYSTEXT_QUESTLIST_NAME_AQ_005_2 [ SYSTEXT_QUESTLIST_SERIES_AQ_005 ] { Sub Story }                                              |
> | eventTextCsAq10053Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (062) SYSTEXT_QUESTLIST_NAME_AQ_005_3 [ SYSTEXT_QUESTLIST_SERIES_AQ_005 ] { Sub Story }                                              |
> | eventTextCsAq10054Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (063) SYSTEXT_QUESTLIST_NAME_AQ_005_4 [ SYSTEXT_QUESTLIST_SERIES_AQ_005 ] { Sub Story }                                              |
> | eventTextCsAq10055Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (064) SYSTEXT_QUESTLIST_NAME_AQ_005_5 [ SYSTEXT_QUESTLIST_SERIES_AQ_005 ] { Sub Story }                                              |
> | eventTextCsAq10061Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10062Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10063Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10064Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10065Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10072Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10073Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10074Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10075Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10081Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10084Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10085Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10091Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10092Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10094Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10095Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq1009hClient.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10101Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10102Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10103Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10104Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10105Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10111Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (050) {Sub Story}                                                                                                              |
> | eventTextCsAq10112Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (051) {Sub Story}                                                                                                              |
> | eventTextCsAq10113Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (052) {Sub Story}                                                                                                              |
> | eventTextCsAq10114Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (053) {Sub Story}                                                                                                              |
> | eventTextCsAq10115Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (054) {Sub Story}                                                                                                              |
> | eventTextCsAq10121Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10122Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10123Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10124Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10125Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10131Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10132Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10133Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10134Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10135Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10141Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (055) {Sub Story}                                                                                                              |
> | eventTextCsAq10142Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (056) {Sub Story}                                                                                                              |
> | eventTextCsAq10143Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (057) {Sub Story}                                                                                                              |
> | eventTextCsAq10144Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (058) {Sub Story}                                                                                                              |
> | eventTextCsAq10145Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (059) {Sub Story}                                                                                                              |
> | eventTextCsAq10151Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10152Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10153Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10154Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq10155Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20161Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20162Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20163Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20171Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20172Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20173Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20181Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20182Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20183Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20191Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20192Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsAq20193Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsC11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsC22Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsD11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00014`<br>Prologue { Dwarf }                                          |
> | eventTextCsD21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00014`<br>[Key Emblem - Yellow]                                       |
> | eventTextCsD31Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of Dolworm                                                                                                                     |
> | eventTextCsE11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00002`<br>Prologue { Elf }                                            |
> | eventTextCsE21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsE31Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsFq10011Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10011Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10012Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
...
> | eventTextCsJq10045Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10051Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10053Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10054Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10055Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10061Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10062Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10063Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10064Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10065Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10071Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10072Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10073Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10074Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10075Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10081Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10082Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10083Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10084Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10085Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10091Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10092Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10093Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10094Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10095Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10101Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10102Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10103Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10104Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10105Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10111Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10112Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10113Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10114Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10115Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10121Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10122Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10123Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10124Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq10125Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20131Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20132Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20133Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20134Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20135Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20142Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20143Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20144Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq20145Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30151Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30152Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30153Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30154Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30155Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30161Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30162Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30163Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30164Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq30165Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40171Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40172Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40173Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40174Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40175Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40181Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40182Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40183Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40184Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsJq40185Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10211Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10221Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10222Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10223Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10224Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10225Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq10251Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Quest (017) {Super Useful}                                                                                                           |
> | eventTextCsKq21091Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq21101Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq21111Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq21112Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq21113Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq21114Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq30284Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq31102Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsKq31103Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
...
> | eventTextCsMq20034Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20035Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq200511To\*Client.win32.json              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 5<br>Destination<br>Changes station/bento dialog          |
> | eventTextCsMq200512To\*Client.win32.json              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 6<br>Destination<br>Changes station/bento dialog          |
> | eventTextCsMq20051Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq2005hClient.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20061Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20081Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20091Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20101Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20121Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20122Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20123Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20141Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20151Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20161Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20171Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20191Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20192Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20201Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20211Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq202213To\*Client.win32.json              | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 7<br>Destination<br>Changes station/bento dialog          |
> | eventTextCsMq20221Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq2022hClient.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20241Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20251Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20252Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsMq20253Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsN12Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (??-10) Story of Lendersia [ 3 Butterflies - Three Way Gate ] { Main Story }                                                         |
> | eventTextCsN22Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (01-11) Story of Melsandy [ 3 Butterflies - Silver ] { Main Story }                                                                  |
> | eventTextCsN32Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (01-14) Story of Seredo [ 3 Butterflies - Amber ] { Main Story }                                                                     |
> | eventTextCsN42Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (01-11) Story of Al-Ahaghiro [ 3 Butterflies - Green ] { Main Story }                                                                |
> | eventTextCsN52Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (01-10) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story }                                                   |
> | eventTextCsN62Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (11-??) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story }                                                   |
> | eventTextCsN72Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Version 2.1 Start                                                                                                                    |
> | eventTextCsO11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00008`<br>Prologue { Ogre }                                           |
> | eventTextCsO21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsO31Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsP11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00011`<br>Prologue { Pukulipo }                                       |
> | eventTextCsP21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsP31Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsS12Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (01/??) Story of the Land of Overlapping Fates [ Pendulum of Fate ] { Main Story }                                                   |
> | eventTextCsS32Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsS82Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsS92Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq10021Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq10031Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq10051Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq20071Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq20081Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq30091Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq40111Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsTq40121Client.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsW11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Story of `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00005`<br>Prologue { Weddie }                                         |
> | eventTextCsW21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsW31Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsY11Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsY21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsY22Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsY32Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextCsZ11s01x0To\*Client.win32.json              | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (01-01) `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 1<br>Destination<br>Changes station/bento dialog           |
> | eventTextCsZ11s02x0To\*Client.win32.json              | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (02-02) `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 2<br>Destination<br>Changes station/bento dialog           |
> | eventTextCsZ11s03x0\*KeyEmblemTo\*Client.win32.json   | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (03-03) `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 3<br>Source,Destination<br>Changes station/bento dialog    |
> | eventTextCsZ11s04x0To\*Client.win32.json              | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (04-04) `Game.locres.yaml:STT_EventPalceName.SYSTXT_PLACENAME_00017`, pt. 4<br>Destination<br>Changes station/bento dialog           |
> | eventTextCsZ21Client.win32.json                       | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (04-07) Story of the Encounters with Hollow [ Ship Shaper Saga ] { Main Story }                                                      |
> | eventTextCsZ31Client.win32.json                       | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (07-25) Story of the Encounters with Hollow [ Ship Shaper Saga ] { Main Story }                                                      |
> | eventTextCsZ41Client.win32.json                       | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (25-32) Story of the Encounters with Hollow [ Ship Shaper Saga ] { Main Story }                                                      |
> | eventTextIeD1AgraTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Dwf_d1000`                                                               |
> | eventTextIeD1AkroDelcServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD1AkroDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD1RaniFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD1ZagbFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2AkkiBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2BoutOusiServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2DamuBos2Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2DaraDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2DaraFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2EzslFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2GataFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2GataMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeD2GataStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2GataTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2KalsFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2MogaChrcServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2MogaFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD2PoikDungServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeD2UlveDungServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeD3BoroDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3BoroFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3DemaFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3DoruCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3DoruFldwServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3DoruIdo1Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Bottom of the Well                                               |
> | eventTextIeD3DoruKingServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3DoruMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeD3DoruStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3DoruTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3GobuFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3KalsBos3Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3KalsBos5Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3KalsDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeD3RyusBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE1KuonDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE1TuskFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE1TuskTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Gen_g4910`                                                               |
> | eventTextIeE2AzurFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2AzurMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeE2AzurStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2AzurTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2HazuBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2InamFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2KazeFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2KiriFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2MoriFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2SuitDungServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeE2SuizFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE2TikaDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE3ImuiBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE3KamiCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE3KamiFldnServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE3KamiFldsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE3KamiKitaServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Elf_e3006`<br>(N) Royal Capital Kamiharmui                               |
> | eventTextIeE3KamiMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeE3KamiTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Elf_e3000`<br>(S) Royal Capital Kamiharmui                               |
> | eventTextIeE3OhorFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeE3SuteDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF1JiyuTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF1KeenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF2GranTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF2JutnTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF4UlveTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF5AruwTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF6KeenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF7JiyuTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeF7KeenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG0ComnTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1MeioDng2Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1MeioDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RackColoServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RackMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeG1RackStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RackTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RendCigaServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RendPortServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RendStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG1RendTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG2GrndShipServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG2SobiTuboServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG9KiseVal3Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeG9MoonTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeL3CasiEntrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO1DazuBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO1LionGateServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Gen_g4900`                                                               |
> | eventTextIeO1LondDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO1NagaDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO1RangFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO1RangTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ogr_01000`                                                               |
> | eventTextIeO2BecoDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2GlenCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2GlenFldeServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2GlenFldwServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2GlenMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeO2GlenStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2GlenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2OlseFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2RandBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2RandInteServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2ViorGateServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO2ZamaFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3BadoFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3GartCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3GartFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3GartIdo1Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Bottom of the Well                                               |
> | eventTextIeO3GartMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeO3GartStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3GartTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3KigaFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO3OlseDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4FootFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4GlenCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4GlenFldeServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4GlenStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4GlenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4LadmDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4RandInteServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeO4ViorGateServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP1EidsDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP1PeshDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP1PukuTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP1PushFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
...
> | eventTextIeP2OlfaHillServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2OlfaIdoServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Bottom of the Well                                               |
> | eventTextIeP2OlfeCakeServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2OlfeFldeServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2OlfeFldwServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2OlfeMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeP2OlfeStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2OlfeTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2OlfeTwn2Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2PakuGaraServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2PakuOffcServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2RinkFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP2SilvHillServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3ChopFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3EpisBos2Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3EpisBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3EpisDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3EpisFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3EpisMeruServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3KiraBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3KiraCampServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3KiraDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3KiraParuServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3LmonFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3LmonIdo1Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Bottom of the Well                                               |
> | eventTextIeP3MegiCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3MegiFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3MegiMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeP3MegiTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeP3RazaDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR1EtenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR1KiyoDungServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR1NaruTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2CocoTownfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2CocoTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2ConiFldfServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR2DracBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2DracFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GakuDormServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GakuGardServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GakuGrndServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GakuOldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GakuSchlServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GakuScl2Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GramBrgr1Server.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (12-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story } - ASIA                                            |
> | eventTextIeR2GramBrgr3Server.win32.json               | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (20-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story } - JAPAN                                           |
> | eventTextIeR2GramCstr1Server.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (12-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story } - ASIA                                            |
> | eventTextIeR2GramCstr2Server.win32.json               | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (12-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story } - JAPAN                                           |
> | eventTextIeR2GramCstr3Server.win32.json               | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (20-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story }                                                   |
> | eventTextIeR2GramTowr1Server.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | (12-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story } - ASIA                                            |
> | eventTextIeR2GramTowr2Server.win32.json               | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (12-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story } - JAPAN                                           |
> | eventTextIeR2GramTowr3Server.win32.json               | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (20-29) Story of Gran Zedora [ 3 Butterflies - Anlucia's Memories ] { Main Story }                                                   |
> | eventTextIeR2GranBrigfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranBrigrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranCastfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranCastrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranCstr2Server.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranCstr3Server.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranMonsfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeR2GranMonsrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeR2GranPortfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranPortrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranScrtrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranTowfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranTowlfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranTowlrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranTownfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2GranTowrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2HimiBossfServer.win32.json               | 🔴  | 🟢  | 🔴  | 🔴  | 🔴  | 🔴    | (283) SYSTEXT_QUESTLIST_NAME_AQ_019_1 [ SYSTEXT_QUESTLIST_SERIES_AQ_019 ] { Sub Story }                                              |
> | eventTextIeR2HimiDungfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2MonsBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeR2MonsFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeR2OukeHakarServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RevlFldnrServer.win32.json               | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR2RnksJim2rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RnksJimurServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RovsFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RovsFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RyuzEsterServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RyuzTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2RyuzTwn2rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2SanmGatefServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2SanmGaterServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2ZedrBos3rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2ZedrBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2ZedrDungfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR2ZedrDungrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR3GuruFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR3GuruFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR3MelsFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR3MelsFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
...
> | eventTextIeR3SyuzFldrServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR3TikaDungfServer.win32.json               | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR3WaldFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR3WaldFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleCrchfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleMonsfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeR4CeleMonsrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeR4CeleSiryfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleSiryrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleTownfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4CeleTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4DarmBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4DarmTmplfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4DarmTmplrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4IgyoFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4IsekBossfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4IsekBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4IsekDungfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4IsekDungrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4MagnDungrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RinjBossfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RinjBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RinjDungfServer.win32.json               | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR4RinjDungrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RinjFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RinjFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RyanFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR4RyanFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahColsfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahColsrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahMonsfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ren_r5000`<br>Monster Tavern                                             |
> | eventTextIeR5ArahMonsrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ren_r5100`<br>Monster Tavern                                             |
> | eventTextIeR5ArahSkilrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahTownfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5ArahTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5DefeFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5DefeFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5JayrDungfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5JayrDungrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5JayrKdusrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5MuruFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5MuruFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5NasmDungfServer.win32.json               | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR5NasmDungrServer.win32.json               | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    |                                                                                                                                      |
> | eventTextIeR5NasmEvtrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5PyraBos2rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5PyraDungfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR5PyraDungrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenFldfServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenMer2Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenMereServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenTownfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenTwn2rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6EtenTwn3rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6HaguFldfServer.win32.json                | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    |                                                                                                                                      |
> | eventTextIeR6HaguFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6HikaTmplrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6JadoBossfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6JadoDungfServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6KiyoDungrServer.win32.json               | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    |                                                                                                                                      |
> | eventTextIeR6NaruIdo1rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Bottom of the Well                                               |
> | eventTextIeR6NaruTownrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6SureFldrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6YukyCasirServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6YukyDng2rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6YukyDungrServer.win32.json               | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeR6YukyEtenrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR6YukyHarlrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR7HikoSkyrServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR7MadeTownrServer.win32.json               | 🟡  | 🟡  | 🟡  | 🟡  | 🟡  | 🟡    |                                                                                                                                      |
> | eventTextIeR7MadeTwn2rServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR7RazeBossrServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeR7RazeFldrServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeRpEtenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ren_r1000`<br>Prologue { Humans }<br>Ethene/Etern Village                |
> | eventTextIeRpHaguFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ren_r1200`<br>Prologue { Humans }<br>Nameless Fields                     |
> | eventTextIeRpHikaRaceServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ren_r1011`<br>Prologue { Humans }<br>Realm of the Gods                   |
> | eventTextIeRpKiyoDungServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Ren_r1600`<br>Prologue { Humans }<br>Clearwater Cave                     |
> | eventTextIeT1ApekTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeT1EjarTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeT2EasaTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeT3KarlTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeT4RushTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeT5MustTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeV1DaisTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeV2ZekuTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeV3BaruTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeV4FaraTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeV5JadiTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeV6GoraTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW1IreiFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW1KoltFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW1LaidFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW1LeenTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_Wed_w1000`<br>Prologue { Weddie }<br>Leen Village                        |
> | eventTextIeW1ShelFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW1TiteDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2AsobHousServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2JureFldtServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2JureIdo1Server.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Bottom of the Well                                               |
> | eventTextIeW2JureLowsServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeW2JureMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeW2JureStatServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2JureTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2LardFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2MuzeFldnServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2MuzeFldsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2NekoBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2NekoDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW2TienDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3BonrFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3EienDungServer.win32.json                | 🟢  | 🟢  | 🟢  | 🟢  | 🟢  | 🟢    |                                                                                                                                      |
> | eventTextIeW3SiikBossServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3SiikDungServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3VarsFldServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3VeriCastServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3VeriFldeServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3VeriFldnServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3VeriFldwServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextIeW3VeriMonsServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_TBD`<br>Monster Tavern                                                   |
> | eventTextIeW3VeriTownServer.win32.json                | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextLiveBasyaServer.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextMainMessageServer.win32.json                 | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    |                                                                                                                                      |
> | eventTextSysBookshelfsServer.win32.json               | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysQuestsServer.win32.json                   | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysWldcServer.win32.json                     | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysWlddwfcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_SYSTXT_LOCATION_COUNTINENT_DOWAHU`<br>Interactable objects in Dwachakka  |
> | eventTextSysWldelfcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_SYSTXT_LOCATION_COUNTINENT_ERUHU`<br>Interactable objects in Eltona      |
> | eventTextSysWldforcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysWldgencServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysWldhsgcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysWldogrcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_SYSTXT_LOCATION_COUNTINENT_OGA`<br>Interactable objects in Ogreed        |
> | eventTextSysWldpukcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_SYSTXT_LOCATION_COUNTINENT_PUKURIPO`<br>Interactable objects in Pukuland |
> | eventTextSysWldrencServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | `Game.locres.yaml:STT_System_Location.SYSTXT_LOCATION_STAGE_SYSTXT_LOCATION_COUNTINENT_REN`<br>Interactable objects in Lendersia     |
> | eventTextSysWldthrcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
> | eventTextSysWldvthcServer.win32.json                  | 🔴  | 🟡  | 🔴  | 🔴  | 🔴  | 🔴    | Interactable objects in world                                                                                                        |
...
>   "$comments": |-
>     1. ^ third-person « singular « ([auxiliary](present « indicative) + [lexical](past « participle))
>     2. ^ third-person « singular « indicative « preterite
>     3. ^ definite article (n, neologism)
>   "de": |-
>     <pc> hat das Alchemie-Topf (Wichtig) erhalten¹!<me 60>
>     <br>
...
>     レシピ屋や　本棚などから　入手できます。
>   "en": |-
>     <pc> received² the Alchemy Pot (Key Item)!<me 60>
>     <br>
...
>     bookshelves.
>   "es": |-
>     <pc> recibió¹ le³ Pote de Alquimia!<me 60>
>     <br>
...
>     レシピ屋や　本棚などから　入手できます。
>   "fr": |-
>     <pc> reçut lea³ Pot d'Alchimie (Objet Important) !<me 60>
>     <br>
...
>     レシピ屋や　本棚などから　入手できます。
>   "it": |-
>     <pc> ricevette¹ ???³ Vaso dell'Alchimia (Oggetto Importante)!<me 60>
>     <br>
...
>     책장 등에서 얻을 수 있습니다.
>   "pt-BR": |-
>     <pc> recebeu¹ Pote para Alquimia (Objeto Importante)!<me 60>
>     <br>
...
>       "de":
>         In der Burgstadt Glen, ein Ogre Krieger, Ban, scheint einen Problem zu
>         haben.
>       "en":
>         In Glen Castle Town, an Ogre warrior, Ban, seems to be somewhat troubled.
>       "es":
>         En la Ciudadela de Glen, parece que un Ogre Guerrero, Ban, está en algún
>         apuro.
>       "fr":
>         Dans la Citadelle de Glen, un Ogre Guerrier, Ban, semble avoir un problème.
>       "it":
>         Nella Cittadella di Glen, un Ogre Guerriero, Ban, sembra in qualche
>         difficoltà.
>       "ja":
>         グレン城下町にいる　オーガの男性　戦士バンが
>         なにか　困っているようだ。
>       "ko":
>         그렌 시가지에 있는 오거 남성 전사 반에게
>         난처한 일이 생긴 듯하다.
>       "pt-BR":
>         Na Cidadela de Glen, parece que um Ogre Guerreiro, Ban, está com algum
>         problema.
>       "zh-Hans":
>         古莲城区的一位叫班的男性奥伽战士
>         似乎遇到了麻烦。
...
>         haben.
>       "en":
>         In Glen Castle Town, an Ogre warrior, Ban, seems to be having problmes.
>       "es":
>         En la Ciudadela de Glen, parece que un Ogre Guerrero, Ban, está en algún
>         apuro.
>       "fr":
...
>       "$comments": |-
>         When expressing a doubt/possibility, follow with subjunctive
>         [0] see `Quest Descriptions table`
>         [1] vowel
>         [2] sg: s/z + consonant
>         [3] plural
>         [4] pl: s/z + consonant, gn/pn/ps/sc/x/y/z, or vowel
>       "de": |-
>         (An|In)⁰   (die|der|das) {STT_System_Location} scheint es, dass  (eine/die|ein/der|ein/das/die³)               {helper noun} namens  {STT_NpcInfo}  einege Problems hat.
>       "en": |-
>         (At|In)                  {STT_System_Location}, it seems that    (an?/the)                                     {helper noun}         {STT_NpcInfo}, is having problems.
>       "es": |-
>         (En)       (la|el|le)    {STT_System_Location}, parece que       (una/ella|un/el|une/le)s³                     {helper noun}         {STT_NpcInfo}, está teniendo algunos problemas.
>       "fr": |-
>         (Sur|En)   (le|la|l')    {STT_System_Location}, semble qu('une/'elle|'un/'il|e/e des³)                         {helper noun}         {STT_NpcInfo}, est ayant quelques problèmes.
>       "it": |-
>         (A|In)⁰    (la|il/lo|l') {STT_System_Location}, sembra che       (una/la/le³|un/uno²/il/lo²/i³/gli⁴|un'¹/l'¹)  {helper noun}         {STT_NpcInfo}, sta avendo qualche problema.
>       "ja": |-
>         {STT_System_Location}で　{determiner}　{STT_NpcInfo}が
>         なにか　困っているようだ。
>       "ko": |-
>         산악 도시 가타라의 전망대에 있는
>         드워프 노인 츠고가 도움이 필요한 듯하다.
>       "pt-BR": |-
>         (Em)⁰   (a|o|ê)       {STT_System_Location}, parece que       (uma/ela|um/ele|unê/ellê)s³                   {helper noun}         {STT_NpcInfo}, está tendo alguns problemas.
>       "zh-Hans": |-
>         山城加塔拉展望台的
>         多瓦夫老人茨科似乎在寻求帮助。
>       "zh-Hant": |-
...
>         [4] pl: s/z + consonant, gn/pn/ps/sc/x/y/z, or vowel
>       "de": |-
>         (An|In)⁰   (die|der|das) {STT_System_Location} scheint es, dass  (eine/die|ein/der|ein/das/die³)               {helper noun} namens  {STT_NpcInfo}  Hilfe sucht.
>       "en": |-
>         (At|In)                  {STT_System_Location}, it seems that    (an?/the)                                     {helper noun}         {STT_NpcInfo}, is seeking assistance.
>       "es": |-
>         (En)       (la|el|le)    {STT_System_Location}, parece que       (una/ella|un/el|une/le)s³                     {helper noun}         {STT_NpcInfo}, está buscando ayuda.
>       "fr": |-
>         (Sur|En)   (le|la|l')    {STT_System_Location}, semble qu('une/'elle|'un/'il|e/e des³)                         {helper noun}         {STT_NpcInfo}, est cherchant de l'aide.
>       "it": |-
>         (A|In)⁰    (la|il/lo|l') {STT_System_Location}, sembra che       (una/la/le³|un/uno²/il/lo²/i³/gli⁴|un'¹/l'¹)  {helper noun}         {STT_NpcInfo}, sta cercando aiuto.
>    // "ja": |-
>         {STT_System_Location}で　{determiner}　{STT_NpcInfo}が　手助けを.求めているようだ。
>       "ko": |-
>         산악 도시 가타라의 전망대에 있는
>         드워프 노인 츠고가 도움이 필요한 듯하다.
>       "pt-BR": |-
>         (Em)⁰   (a|o|ê)       {STT_System_Location}, parece que       (uma/ela|um/ele|unê/ellê)s³                   {helper noun}         {STT_NpcInfo}, está buscando ajuda.
>       "zh-Hans": |-
>         山城加塔拉展望台的
>         多瓦夫老人茨科似乎在寻求帮助。
>       "zh-Hant": |-
